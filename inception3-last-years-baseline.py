...
print(os.listdir("./train_val2019"))
...
class Params:
    ...
    resume = './checkpoint_ep36.pth.tar'    # path to trained model
    train_file = './train2019.json'      # path to train file
    val_file = './test2019.json'         # path to test file
    data_root_train = './train_val2019/' # path to train images
    data_root_test = './test2019/'       # path to test images
...
if args.resume:
    if os.path.isfile(args.resume):
        ...
        checkpoint = torch.load(args.resume, map_location={"cuda" : "cpu"})
...
get_ipython().system('pip install python==3')
